    ...
    for category in categories:
        ...
        if any(word in category_lower for word in
               ['брюки', 'футболка', 'платье', 'кофта', 'рубашка', 'юбка', 'куртка', 'пальто', 'джемпер', 'шорты',
                ...
                'заколка', 'пуловер', 'блуза', 'фуфайка', 'сандал']):
